 ...
 *
 * $Id: packet-lldp.c 54249 2013-12-19 15:49:09Z eapache $
 *
...
static int hf_ieee_802_1qaz_dcbx_ETS_maxTC = -1;
static int hf_ieee_802_1qaz_dcbx_ETS_CBS_flag = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority0 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority1 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority2 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority3 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority4 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority5 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority6 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_PAT_priority7 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage0 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage1 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage2 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage3 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage4 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage5 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage6 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage7 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class0 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class1 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class2 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class3 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class4 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class5 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class6 = -1;
static int hr_ieee_802_1qaz_dcbx_ETS_TSA_class7 = -1;

static int hf_ieee_802_1qaz_dcbx_willing_flag = -1;
static int hf_ieee_802_1qaz_dcbx_mbc_flag = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_cap = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority0 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority1 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority2 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority3 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority4 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority5 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority6 = -1;
static int hf_ieee_802_1qaz_dcbx_pfc_priority7 = -1;
static int hf_ieee_802_1qaz_dcbx_app_priority_tbl_protocol_id = -1;
static int hf_ieee_802_1qaz_dcbx_app_priority_tbl_sel = -1;
static int hf_ieee_802_1qaz_dcbx_app_priority_tbl_priority = -1;
...
static gint ett_org_spc_ieee_802_1_10 = -1;
static gint ett_org_spc_ieee_802_1_11 = -1;
static gint ett_org_spc_ieee_802_1_12 = -1;

static gint ett_org_spc_ieee_802_1_11_pfc = -1;
static gint ett_org_spc_ieee_802_1_11_prat =  -1;
static gint ett_org_spc_ieee_802_1_11_tcbt =  -1;
static gint ett_org_spc_ieee_802_1_11_tsaat =  -1;
static gint ett_org_spc_ieee_802_1_12_app_prioriry_tbl = -1;
static gint ett_org_spc_ieee_802_1_12_app_prioriry_subtbl = -1;
...
static const value_string ieee_802_1_subtypes[] = {
	...
	{ 0x09,	"DCBX - ETS Configuration TLV" },
	{ 0x0A,	"DCBX - ETS Recommendation TLV"},
	{ 0x0B,	"DCBX - Priority-based Flow Control Configuration TLV"},
	{ 0x0C,	"DCBX - Application Priority TLV"},

	{ 0, NULL }
};

static const value_string ieee_802_1_dcbx_mbc_capability[] = {
	{ 0, "Capable" }, /* Yes, if 0 then Capable */
	{ 1, "Not capable" },
	{ 0, NULL }
};
...
dissect_ieee_802_1_tlv(tvbuff_t *tvb, packet_info *pinfo _U_, proto_tree *tree, guint32 offset)
{
	...
	case 0x09: /*DCBX ETS Configuration*/
	{
	    if (tree)
		{
			proto_item *prat_item = NULL;
			proto_tree *prat_tree = NULL;
			proto_item *tcbt_item = NULL;
			proto_tree *tcbt_tree = NULL;
			proto_item *tsaat_item = NULL;
			proto_tree *tsaat_tree = NULL;

			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_willing_flag, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_ETS_CBS_flag, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_ETS_maxTC, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;

			prat_item = proto_tree_add_text(tree, tvb, tempOffset, 4, "Priority assigment table");
			prat_tree = proto_item_add_subtree(prat_item, ett_org_spc_ieee_802_1_11_prat);
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority0, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority1, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority2, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority3, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority4, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority5, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority6, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(prat_tree, hr_ieee_802_1qaz_dcbx_ETS_PAT_priority7, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;

			tcbt_item = proto_tree_add_text(tree, tvb, tempOffset, 8, "Traffic class bandwidth assigment table");
			tcbt_tree = proto_item_add_subtree(tcbt_item, ett_org_spc_ieee_802_1_11_tcbt);
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage0, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage1, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage2, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage3, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage4, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage5, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage6, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tcbt_tree, hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage7, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;

			tsaat_item = proto_tree_add_text(tree, tvb, tempOffset, 8, "TSA Assignment Table");
			tsaat_tree = proto_item_add_subtree(tsaat_item, ett_org_spc_ieee_802_1_11_tsaat);
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class0, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class1, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class2, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class3, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class4, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class5, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class6, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			proto_tree_add_item(tsaat_tree, hr_ieee_802_1qaz_dcbx_ETS_TSA_class7, tvb, tempOffset, 1, ENC_BIG_ENDIAN);

		}
	    break;
	}
	case 0x0A: /*DCBX ETS Recommendation*/
	{
	    if (tree)
		{
			proto_item *prat_item = NULL;
	    ...
	    if (tree)
{
			...
			proto_tree *pfc_tree = NULL;

			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_willing_flag, tvb, tempOffset, 1, ENC_BIG_ENDIAN);	
			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_mbc_flag, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(tree, hf_ieee_802_1qaz_dcbx_pfc_cap, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			tempOffset++;
			pfc = tvb_get_guint8(tvb, tempOffset);
			pfc_item = proto_tree_add_text(tree, tvb, tempOffset, 1, "PFC Enable bit vector (%x)",pfc);
			pfc_tree = proto_item_add_subtree(pfc_item, ett_org_spc_ieee_802_1_11_pfc);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority0, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority1, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority2, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority3, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority4, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority5, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority6, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
			proto_tree_add_item(pfc_tree, hf_ieee_802_1qaz_dcbx_pfc_priority7, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
		}
	    break;
	}
    case 0x0C:
    {
        tempShort = tvb_get_ntohs(tvb, offset-5);
        /* Get application priority table length */
        tempLen = TLV_INFO_LEN(tempShort) - 5;

        proto_tree_add_text(tree, tvb, tempOffset, 1, "Reserved");
        tempOffset++; //skip reserved byte
        ...
        if (tree)
        {
            if(tempLen == 0)
            {
            	proto_tree_add_text(tree, tvb, 0, 0, "Application Priority Table (empty)");
            }
            else
            {
            	proto_item *app_table = NULL;
            	proto_tree *app_table_tree = NULL;

            	app_table = proto_tree_add_text(tree, tvb, tempOffset, tempLen, "Application Priority Table (%d items)",tempLen/3);
            	app_table_tree = proto_item_add_subtree(app_table, ett_org_spc_ieee_802_1_12_app_prioriry_tbl);
            	...
            	while (tempLen>0)
            	{
            		proto_item *subtable = NULL;
            		proto_tree *subtable_tree = NULL;

            		subtable = proto_tree_add_text(app_table_tree, tvb, tempOffset, 3, "Table %d",counter);
            		subtable_tree = proto_item_add_subtree(subtable, ett_org_spc_ieee_802_1_12_app_prioriry_subtbl);

            		proto_tree_add_item(subtable_tree, hf_ieee_802_1qaz_dcbx_app_priority_tbl_priority, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
            		proto_tree_add_item(subtable_tree, hf_ieee_802_1qaz_dcbx_app_priority_tbl_sel, tvb, tempOffset, 1, ENC_BIG_ENDIAN);
            		tempOffset++;
            		proto_tree_add_item(subtable_tree, hf_ieee_802_1qaz_dcbx_app_priority_tbl_protocol_id, tvb, tempOffset, 2, ENC_BIG_ENDIAN);
...
proto_register_lldp(void)
{
	...
	static hf_register_info hf[] = {
		...
		{ &hf_ieee_802_1qaz_dcbx_ETS_CBS_flag,
		    { "Credit-based Shaper", "lldp.ieee.802_1.dcbx.CBS_flag", FT_BOOLEAN, 8, 
		    TFS(&tfs_supported_not_supported), 0x40, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_ETS_maxTC,
	        { "Max TCs", "lldp.ieee.802.1.dcbx.maxTC", FT_UINT8, BASE_DEC, 
	        NULL, 0x07, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority0, 
			{ "Priority 0", "lldp.ieee.802_1.dcbx.ETS.PAT.priority0", FT_UINT8, BASE_DEC,
			NULL, 0x0F, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority1, 
			{ "Priority 1", "lldp.ieee.802_1.dcbx.ETS.PAT.priority1", FT_UINT8, BASE_DEC,
			NULL, 0xF0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority2, 
			{ "Priority 2", "lldp.ieee.802_1.dcbx.ETS.PAT.priority2", FT_UINT8, BASE_DEC,
			NULL, 0x0F, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority3, 
			{ "Priority 3", "lldp.ieee.802_1.dcbx.ETS.PAT.priority3", FT_UINT8, BASE_DEC,
			NULL, 0xF0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority4, 
			{ "Priority 4", "lldp.ieee.802_1.dcbx.ETS.PAT.priority4", FT_UINT8, BASE_DEC,
			NULL, 0x0F, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority5, 
			{ "Priority 5", "lldp.ieee.802_1.dcbx.ETS.PAT.priority5", FT_UINT8, BASE_DEC,
			NULL, 0xF0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority6, 
			{ "Priority 6", "lldp.ieee.802_1.dcbx.ETS.PAT.priority6", FT_UINT8, BASE_DEC,
			NULL, 0x0F, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_PAT_priority7, 
			{ "Priority 7", "lldp.ieee.802_1.dcbx.ETS.PAT.priority7", FT_UINT8, BASE_DEC,
			NULL, 0xF0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage0, 
			{ "Traffic Class 0 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage0", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage1, 
			{ "Traffic Class 1 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage1", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage2, 
			{ "Traffic Class 2 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage2", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage3, 
			{ "Traffic Class 3 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage3", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage4, 
			{ "Traffic Class 4 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage4", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage5, 
			{ "Traffic Class 5 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage5", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage6, 
			{ "Traffic Class 6 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage6", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TCB_percentage7, 
			{ "Traffic Class 7 (%)", "lldp.ieee.802_1.dcbx.ETS.TCB.percentage7", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class0, 
			{ "Traffic Class 0", "lldp.ieee.802_1.dcbx.ETS.TSA.class0", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class1, 
			{ "Traffic Class 1", "lldp.ieee.802_1.dcbx.ETS.TSA.class1", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class2, 
			{ "Traffic Class 2", "lldp.ieee.802_1.dcbx.ETS.TSA.class2", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class3, 
			{ "Traffic Class 3", "lldp.ieee.802_1.dcbx.ETS.TSA.class3", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class4, 
			{ "Traffic Class 4", "lldp.ieee.802_1.dcbx.ETS.TSA.class4", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class5, 
			{ "Traffic Class 5", "lldp.ieee.802_1.dcbx.ETS.TSA.class5", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class6, 
			{ "Traffic Class 6", "lldp.ieee.802_1.dcbx.ETS.TSA.class6", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hr_ieee_802_1qaz_dcbx_ETS_TSA_class7, 
			{ "Traffic Class 7", "lldp.ieee.802_1.dcbx.ETS.TSA.class7", FT_UINT8, BASE_DEC,
			NULL, 0, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_willing_flag,
			{ "Willing", "lldp.ieee.802_1.dcbx.willing_flag", FT_BOOLEAN, 8,
			NULL, 0x80, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_mbc_flag,
			{ "MACsec Bypass Capability", "lldp.ieee.802_1.dcbx.mbc_flag", FT_BOOLEAN, 8,
			VALS(ieee_802_1_dcbx_mbc_capability), 0x40, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_cap,
			{ "PFC capability", "lldp.ieee.802_1.dcbx.pfc_cap", FT_UINT8, BASE_DEC,
			NULL, 0x0F, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority0, 
			{ "Priority 0", "lldp.ieee.802_1.dcbx.pfc.priority0", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x01, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority1, 
			{ "Priority 1", "lldp.ieee.802_1.dcbx.pfc.priority1", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x02, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority2,  
			{ "Priority 2", "lldp.ieee.802_1.dcbx.pfc.priority2", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x04, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority3, 
			{ "Priority 3", "lldp.ieee.802_1.dcbx.pfc.priority3", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x08, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority4, 
			{ "Priority 4", "lldp.ieee.802_1.dcbx.pfc.priority4", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x10, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority5, 
			{ "Priority 5", "lldp.ieee.802_1.dcbx.pfc.priority5", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x20, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority6, 
			{ "Priority 6", "lldp.ieee.802_1.dcbx.pfc.priority6", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x40, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_pfc_priority7, 
			{ "Priority 7", "lldp.ieee.802_1.dcbx.pfc.priority7", FT_BOOLEAN, 8,
			TFS(&tfs_enabled_disabled), 0x80, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_app_priority_tbl_priority, 
			{ "Priority", "lldp.ieee.802_1.dcbx.application_priority_table.priority", FT_UINT8, BASE_DEC,
			NULL, 0xE0, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_app_priority_tbl_sel, 
			{ "Sel", "lldp.ieee.802_1.dcbx.application_priority_table.sel", FT_UINT8, BASE_DEC,
			NULL, 0x07, NULL, HFILL }
		},
		{ &hf_ieee_802_1qaz_dcbx_app_priority_tbl_protocol_id, 
			{ "Protocol ID", "lldp.ieee.802_1.dcbx.application_priority_table.protocol_id", FT_UINT16, BASE_DEC,
			NULL, 0x0, NULL, HFILL }
		},
	...
	static gint *ett[] = {
		...
		&ett_org_spc_ieee_802_1_10,
		&ett_org_spc_ieee_802_1_11,
		&ett_org_spc_ieee_802_1_11_pfc,
		&ett_org_spc_ieee_802_1_11_prat,
		&ett_org_spc_ieee_802_1_11_tcbt,
		&ett_org_spc_ieee_802_1_11_tsaat,
		&ett_org_spc_ieee_802_1_12,
        	&ett_org_spc_ieee_802_1_12_app_prioriry_tbl,
        	&ett_org_spc_ieee_802_1_12_app_prioriry_subtbl,
